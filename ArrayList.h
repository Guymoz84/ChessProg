...
/**
 * Returns an ArrayList of all moves for the get_moves option
 * @param arraylist - all moves possible for the current player.
 * @return
 * The sorted list of possible moves for the current player.
 */
ArrayList* sortForGetMoves(ArrayList* arraylist);
/**
 * Sorting function to use in qsort - sort between two moves
 * @param two moves
 * @return
 * 1 if move1 ">" than move2, -1 else
 */
